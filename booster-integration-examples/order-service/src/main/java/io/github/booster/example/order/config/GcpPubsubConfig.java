package io.github.booster.example.order.config;
...
public class GcpPubsubConfig {
    ...
    public GcpPubsubConfig(
            ...
            String subscription,
            @Value(value = "${booster.gcp.pubsub.create:false}" )
            boolean create
    ) {
    ...
    private void createTopic(
        ...
        log.info("order service - creating topic [{}]", topicId);
        ...
        try (TopicAdminClient topicAdminClient = TopicAdminClient.create(topicAdminSettings)) {
            ...
            log.info("order service - topic [{}] created for project [{}]", topicId, this.projectId);
        }
    }
    ...
    private void createSubscription(
        ...
        log.info("order service - creating subscription: [{}]", subscriptionId);
    ...
    public PubSubTemplate pubSubTemplate(
        ...
        log.info("order service - pubsub template created");
