 ...
 */
interface KeyedObjectCache<K, V> {

    companion object {
        private val log = LoggerFactory.getLogger(KeyedObjectCache::class.java)
    }
    ...
    /**
     * Returns an object if it exists in cache or can be created by [KeyedObjectCache],
