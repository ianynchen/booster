...
object CompressionTestData {

    val TEXT_TO_COMPRESS =
        """
...
fun getBase64EncodedString(bytes: ByteArray) = Base64.getEncoder().encodeToString(bytes)

fun getUTF8Bytes(str: String) = str.toByteArray(StandardCharsets.UTF_8)

fun getBase64DecodedBytes(str: String) =
    Base64.getDecoder().decode(getUTF8Bytes(str))
